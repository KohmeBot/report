...
func NewTextInvoker(invoker *chataisdk.ChatAIInvoker, system string, online bool, thinking bool) *TextInvoker {
	return &TextInvoker{
		invoker:  invoker,
		system:   system,
		online:   online,
...
func (i *TextInvoker) DoRequest(req string) (string, error) {
	largeModel, err := i.invoker.NewModel(i.system, i.online, i.thinking, false)
